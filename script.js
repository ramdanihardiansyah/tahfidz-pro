...
function finishLogin(){
  ...
  if(logoPrev.dataset.logoData){
    settings.logoData=logoPrev.dataset.logoData;
    // Update favicon dengan logo yang baru diupload
    updateFavicon(logoPrev.dataset.logoData);
  }
...
function init(){
  ...
  if(settings.logoData){
    ...
    // Update favicon
    updateFavicon(settings.logoData);
  }
